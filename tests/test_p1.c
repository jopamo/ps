...
void test_parseIterations_Positive(void)
{
    TEST_ASSERT_EQUAL_INT(10, parseIterations("10"));
}

void test_parseIterations_Zero(void)
{
    TEST_ASSERT_EQUAL_INT(-1, parseIterations("0"));
}

void test_parseIterations_Negative(void)
{
    TEST_ASSERT_EQUAL_INT(-1, parseIterations("-5"));
}

void test_parseIterations_NonNumeric(void)
{
    TEST_ASSERT_EQUAL_INT(-1, parseIterations("abc"));
}
